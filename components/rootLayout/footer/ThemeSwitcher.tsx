...
const ThemeSwitcher: FC = () => {
    ...
    useEffect(() => {
        const getCurState = localStorage.getItem('darkMode') === 'true';
        setDarkMode(getCurState);
    }, []);
    ...
    return (
        <label className='relative flex cursor-pointer shadow-md select-none items-center sm:flex-col flex-row justify-center rounded-md bg-white p-1 h-fit'>
            <input
                type='checkbox'
                className='sr-only'
                checked={isDarkMode}
            ...
            <span
                className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${
                    !isDarkMode ? 'text-primary bg-orange-400 text-white' : 'text-black'
                }`}
            >
                <svg
                    width='16'
            ...
            <span
                className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${
                isDarkMode ? 'text-primary bg-slate-800' : 'text-black'
                }`}
            >
                <svg
                    width='16'
